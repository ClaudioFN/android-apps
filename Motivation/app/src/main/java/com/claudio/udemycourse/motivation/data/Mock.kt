package com.claudio.udemycourse.motivation.data
...
class Mock {
    ...
    val mListPhrase = listOf<Phrase>(
        ...
        Phrase("Not all those who wander are lost.", sunny),
        Phrase("Even the smallest person can change the course of the future.", happy),
        Phrase("You step into the road, and if you don’t keep your feet, there is no knowing where you might be swept off to.", sunny)
    )
